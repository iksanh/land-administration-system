...
/**
 * Ports app/db/seeder_wilayah.py — seeds the 37 provinsi reference rows.
 * Kabupaten/kecamatan/desa are loaded separately (bulk import) in the source app.
 */
class WilayahSeeder extends Seeder
{
    public function run(): void
    {
        $provinsi = [
            ...
            ['92', 'PAPUA BARAT'], ['93', 'PAPUA SELATAN'], ['94', 'PAPUA TENGAH'],
            ['95', 'PAPUA PEGUNUNGAN'],
        ];

        foreach ($provinsi as [$id, $nama]) {
            RefProvinsi::firstOrCreate(['id' => $id], ['nama' => $nama]);
        }
    }
}
