<div class="min-h-screen bg-[#f0f2f5] flex items-center justify-center p-4">
    <div class="bg-white p-8 sm:p-10 rounded-xl shadow-sm border border-gray-100 w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-800 tracking-tight">E- CHEKING LAND REGISTRASTION </h1>
        ...
        @else
            ...
            <form wire:submit="verifyOtp" class="space-y-5">
                <p class="text-sm text-gray-500 text-center -mt-2">
                    ...
                    <span class="block text-xs text-gray-400 mt-1">(atau salah satu kode pemulihan)</span>
                </p>
                <div>
                    <input
                        type="text"
                        ...
                        wire:model="otp"
                        autofocus
                        class="w-full border border-gray-300 rounded-md px-4 py-2.5 text-center text-lg tracking-[0.4em] font-mono transition-all duration-200 focus:outline-none focus:border-[#1677ff] focus:ring-2 focus:ring-[#1677ff]/20 bg-white"
                        placeholder="••••••"
                    />
                </div>
                <div class="pt-2">
