                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-3">
                                <button wire:click="edit('{{ $item->id }}')" class="text-[#1677ff] hover:text-[#0958d9] font-medium text-xs">Edit</button>
                                <span class="w-px h-3 bg-gray-300"></span>
                                <button wire:click="delete('{{ $item->id }}')" wire:confirm="Hapus layanan {{ $item->nama }}?" class="text-[#ff4d4f] hover:text-[#cf1322] font-medium text-xs">Hapus</button>
                            </div>
                        </td>
                    </tr>
                @empty
