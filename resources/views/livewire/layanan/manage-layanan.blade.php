                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-2">
                                <x-action-btn icon="edit" variant="primary" wire:click="edit('{{ $item->id }}')">Edit</x-action-btn>
                                <x-action-btn icon="delete" variant="danger" wire:click="delete('{{ $item->id }}')" wire:confirm="Hapus layanan {{ $item->nama }}?">Hapus</x-action-btn>
                            </div>
                        </td>
                    </tr>
                @empty
